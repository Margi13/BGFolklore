...
namespace BGFolklore.Data.Migrations
{
    ...
    [Migration("20210915064308_RemoveDescriptionColumnsFromEthnoAreas")]
    partial class RemoveDescriptionColumnsFromEthnoAreas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BGFolklore.Data.Models.Gallery.EthnographicArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EthnographicAreas");
                });

            modelBuilder.Entity("BGFolklore.Data.Models.Gallery.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("CostumeType")
                        .HasColumnType("int");

                    b.Property<string>("Description")
                        .HasColumnType("text");

                    b.Property<int>("EthnoAreaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EthnoAreaId");

                    b.ToTable("Images");
                });

            modelBuilder.Entity("BGFolklore.Data.Models.Gallery.Video", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BGFolklore.Data.Models.Gallery.Image", b =>
                {
                    b.HasOne("BGFolklore.Data.Models.Gallery.EthnographicArea", "EthnoArea")
                        .WithMany()
                        .HasForeignKey("EthnoAreaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("EthnoArea");
                });
